...
export const Timeline = ({
  ...
  return (
    // PERBAIKAN: Tambahkan bg-white untuk mode terang
    <div
      className="max-w-7xl mx-auto bg-white dark:bg-neutral-950 md:px-10"
      ref={containerRef}
    >
      <div className="container w-full mx-auto py-20 flex flex-col items-start justify-start gap-10 text-start">
        ...
        >
          <div className="flex flex-col items-start justify-start gap-5 text-start">
            {typeof title === "string" ? (
              // PERBAIKAN: Tambahkan text-neutral-900
            ...
            {typeof subtitle === "string" ? (
              <AnimatedContent
                ...
                delay={0}
              >
                {/* PERBAIKAN: Typo darK menjadi dark, tambah text-neutral-700 */}
              ...
              <div className="flex justify-start pt-10 gap-10">
                <div className="sticky flex flex-col md:flex-row items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                  ...
                  <div className="flex flex-col items-end justify-end gap-4 self-start max-w-xs lg:max-w-sm md:w-full">
                    ...
                    <h3 className="hidden md:block text-xl md:pl-20 md:text-4xl font-bold text-blue-600 dark:text-blue-primary">
                      {item.title}
                    </h3>
                    {/* PERBAIKAN: Warna deskripsi */}
                    <p className="text-sm md:text-base text-neutral-600 dark:text-neutral-400 max-w-2/3 text-right">
                      {item.description}
                    </p>
